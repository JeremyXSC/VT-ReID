...
class LinearClassifier(nn.Module):
    ...
    def forward(self, block):
        (B, C, T, H, W) = block.shape # (1,3,frame,128,128)
        feat3d = self.backbone(block) # (1,1024,frame/8,4,4)
        feat3d = F.adaptive_avg_pool3d(feat3d, (1,1,1)) # [B,C,1,1,1] # (1,1024,1,1,1)
        feat3d = feat3d.view(B, self.param['feature_size']) # [B,C] # (1,1024)
